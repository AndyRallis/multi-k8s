docker build -t nashno9/multi-client:latest nashno9/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t nashno9/multi-server:latest nashno9/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t nashno9/multi-worker:latest nashno9/multi-worker:$SHA -f ./worker/Dockerfile ./worker
